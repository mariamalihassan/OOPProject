...
namespace OOPProject.Helpers
{
	...
	{
		public static LibirayBranch Seed()
		{
			// ── Librarian ────────────────────────────────────────────
			Libirian manager = new(	libirianId: "LIB-01",	name: "Sara Ahmed",	salary: 8500m,phone: "01012345678",hireDate: new DateOnly(2019, 3, 15));


			// ── Branch ───────────────────────────────────────────────
			LibirayBranch branch = new("BR-01", "City Library — Nasr City Branch", "15 Nasr Road, Nasr City, Cairo",
